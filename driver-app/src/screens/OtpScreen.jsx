...
export default function OtpScreen({ route, navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.digitRow}>
        {digits.map((d, i) => (
          <TextInput key={i} ref={r => refs.current[i] = r}
            ...
            onChangeText={t => handleChange(t, i)} onFocus={() => setFocused(i)} />
        ))}
      </View>
      ...
      <TouchableOpacity style={[styles.btn, !allFilled && styles.btnDisabled]} onPress={handleVerify} disabled={loading || !allFilled}>
